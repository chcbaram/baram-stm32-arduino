...
//-- hw_def.h 의 GpioPinName_t 를 그대로 쓴다. (LCD_CS=0, LCD_DC=1, LCD_BL=2)
#define _PIN_DEF_BKT    LCD_BL
#define _PIN_DEF_DC     LCD_DC
...
bool st7735Reset(void)
{
  ...
  st7735SetRotation(1);   // chcbaram/stm32h750mv 에서 확인한 값
